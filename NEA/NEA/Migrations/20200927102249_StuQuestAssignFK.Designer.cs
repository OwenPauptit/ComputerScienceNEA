...
namespace NEA.Migrations
{
    ...
    [Migration("20200927102249_StuQuestAssignFK")]
    partial class StuQuestAssignFK
    {
            ...
            modelBuilder.Entity("NEA.Models.StudentQuestion", b =>
                {
                    ...
                    b.Property<int?>("StudentAssignmentSimulationID")
                        .HasColumnType("int");

                    b.Property<string>("StudentAssignmentUserID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("StudentAssignmentUserID", "StudentAssignmentSimulationID");

                    b.HasIndex("UserID", "SimulationID");
            ...
            modelBuilder.Entity("NEA.Models.StudentQuestion", b =>
                {
                    ...
                    b.HasOne("NEA.Models.StudentAssignment", null)
                        .WithMany("StudentQuestions")
                        .HasForeignKey("StudentAssignmentUserID", "StudentAssignmentSimulationID");

                    b.HasOne("NEA.Models.StudentAssignment", "StudentAssignment")
                        .WithMany()
                        .HasForeignKey("UserID", "SimulationID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
