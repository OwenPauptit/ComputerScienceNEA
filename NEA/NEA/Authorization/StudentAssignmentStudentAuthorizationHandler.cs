...
{
    public class StudentAssignmentStudentAuthorizationHandler : AuthorizationHandler<OperationAuthorizationRequirement, StudentAssignment>
    {
        UserManager<NEAUser> _userManager;

        public StudentAssignmentStudentAuthorizationHandler(UserManager<NEAUser>
            userManager)
        {
